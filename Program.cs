...
namespace osm
{
    class Program
    {
        ...
        //
        static bool useIndexedCheck = false; // использовать/не использовать индексный массив
        ...
        static int numPopulationCityFiltr = 100000; // фильтр для атрибута Population 
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                OSM_WriteLog(fileLog, String.Format("== Find: Country, City ( population >= {0} )", numPopulationCityFiltr));
                OSM_WriteLog(fileLog, "===========================");
            ...
            finally
            {
                ...
                OSM_WriteLog(fileLog, String.Format("== Country: {0} ; City ( population >= {3} ): {1}", cntNodeCountry, cntNodeCity, numPopulationCityFiltr));
